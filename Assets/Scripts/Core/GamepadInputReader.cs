...
public static class GamepadInputReader
{
    ...
    public static Vector2 Navigation => Controls != null ? Controls.UI.Navigate.ReadValue<Vector2>() : Vector2.zero;
    ...
    public static bool CancelPressed => Controls != null && Controls.UI.Cancel.triggered;

    public static bool DpadUpPressed => Controls != null && Controls.GamePlay.DPadUp.triggered;
    public static bool DpadDownPressed => Controls != null && Controls.GamePlay.DPadDown.triggered;
    public static bool StartPressed => Controls != null && Controls.GamePlay.Start.triggered;
