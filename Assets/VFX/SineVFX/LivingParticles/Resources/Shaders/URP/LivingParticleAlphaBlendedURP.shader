	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float temp_output_57_0 = ( tex2D( _FinalTexture, uv_FinalTexture ).r * clampResult58 * staticSwitch63 * ( 1.0 - TooClose75 ) * input.ase_color.a );
				...
				float3 Color = ( staticSwitch81 * input.ase_color * _FinalPower ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_FinalTexture = input.ase_texcoord2.xy * _FinalTexture_ST.xy + _FinalTexture_ST.zw;
				float clampResult58 = clamp( _SoftParticleDistance , 1.0 , 1.0 );
				...
				float staticSwitch63 = 1.0;
				#endif
				float4 appendResult17 = (float4(input.ase_texcoord2.z , input.ase_texcoord2.w , input.ase_texcoord4.x , 0.0));
				float DistanceMask45 = ( 1.0 - distance( appendResult17 , _Affector ) );
				float clampResult23 = clamp( (0.0 + (( DistanceMask45 + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 );
				float temp_output_33_0 = pow( clampResult23 , _DistancePower );
				float clampResult71 = clamp( ( ( temp_output_33_0 - _CloseFadeDistance ) * 8.0 ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_FinalTexture = input.ase_texcoord3.xy * _FinalTexture_ST.xy + _FinalTexture_ST.zw;
				float clampResult58 = clamp( _SoftParticleDistance , 1.0 , 1.0 );
				...
				float staticSwitch63 = 1.0;
				#endif
				float4 appendResult17 = (float4(input.ase_texcoord3.z , input.ase_texcoord3.w , input.ase_texcoord5.x , 0.0));
				float DistanceMask45 = ( 1.0 - distance( appendResult17 , _Affector ) );
				float clampResult23 = clamp( (0.0 + (( DistanceMask45 + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 );
				float temp_output_33_0 = pow( clampResult23 , _DistancePower );
				float clampResult71 = clamp( ( ( temp_output_33_0 - _CloseFadeDistance ) * 8.0 ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 uv_FinalTexture = input.ase_texcoord.xy * _FinalTexture_ST.xy + _FinalTexture_ST.zw;
				float clampResult58 = clamp( _SoftParticleDistance , 1.0 , 1.0 );
				...
				float staticSwitch63 = 1.0;
				#endif
				float4 appendResult17 = (float4(input.ase_texcoord.z , input.ase_texcoord.w , input.ase_texcoord2.x , 0.0));
				float DistanceMask45 = ( 1.0 - distance( appendResult17 , _Affector ) );
				float clampResult23 = clamp( (0.0 + (( DistanceMask45 + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 );
				float temp_output_33_0 = pow( clampResult23 , _DistancePower );
				float clampResult71 = clamp( ( ( temp_output_33_0 - _CloseFadeDistance ) * 8.0 ) , 0.0 , 1.0 );
...
Node;AmplifyShaderEditor.Vector4Node;20;-2719.338,-964.8239;Float;False;Global;_Affector;_Affector;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-3452.354,-29.66669;Float;False;Property;_Distance;Distance;8;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-2772.243,30.36653;Float;False;Property;_DistancePower;Distance Power;9;0;Create;True;0;0;0;False;0;False;1;4;0.2;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-2323.462,-404.4654;Float;False;Property;_CloseFadeDistance;Close Fade Distance;16;0;Create;True;0;0;0;False;0;False;0.65;0.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1251.323,-1023.654;Float;False;Property;_FinalMaskMultiply;Final Mask Multiply;5;0;Create;True;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-902.6503,-85.84533;Float;False;Property;_CameraFadeDistance;Camera Fade Distance;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;36;-876.8575,-1445.834;Float;False;Property;_FinalColor2;Final Color 2;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch;78;-1578.043,-334.3803;Float;False;Property;_CloseFadeEnabled;Close Fade Enabled;15;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;-871.1545,-1259.316;Float;False;Property;_FinalColor;Final Color;2;0;Create;True;0;0;0;False;0;False;1,0,0,1;0.4264701,0.9050709,1,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;65;-887.9404,26.14351;Float;False;Property;_CameraFadeOffset;Camera Fade Offset;14;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;82;-437.946,-1036.915;Inherit;True;Property;_Ramp;Ramp;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-915.9873,-191.9568;Float;False;Property;_SoftParticleDistance;Soft Particle Distance;17;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;77;-334.5116,153.5335;Inherit;False;75;TooClose;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;114;-622.4772,-165.164;Float;False;Constant;_Float6;Float 6;20;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;81;45.88528,-1095.46;Float;False;Property;_RampEnabled;Ramp Enabled;6;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;63;-182.9198,-21.59186;Float;False;Property;_CameraFadeEnabled;Camera Fade Enabled;12;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;97;483.5101,-660.0831;Float;False;Property;_MaskOpacityPower;Mask Opacity Power;19;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;41;-2249.719,-1117.26;Inherit;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.StaticSwitch;91;1144.967,-396.0954;Float;False;Property;_MaskAffectsTransparency;Mask Affects Transparency;18;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;55;-249.978,792.1231;Inherit;False;53;ResultMask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-220.0562,967.436;Float;False;Property;_OffsetPower;Offset Power;10;0;Create;True;0;0;0;False;0;False;0;2.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-30.49794,-980.2728;Float;False;Property;_FinalPower;Final Power;4;0;Create;True;0;0;0;False;0;False;6;10;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;125;2555.304,-351.5145;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=A252A2C1203629C199EF7475A64F209CD17C8FED